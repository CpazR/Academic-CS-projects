 ...
 *          If the name is matched, then display all the co-actors in each movie which the user-input actor is in
 * Author: Yi Pike
...
int main(int argc, char* argv[])
{
    ...
    // Repeatedly ask the user to type an actor's name until user types "exit"
    ...
    // then display all the co-actors in each of the movies the user-typed actor acts (excluding the user-typed actor)
