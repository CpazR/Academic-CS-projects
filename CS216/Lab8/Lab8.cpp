    ...
    while (true)
    {
        ...
        switch (option)
        {
            ...
            case 2: {   cout << "Buildings are in dictionary order by buildings' names: " << endl;
                        BuildingList sortName=UKY_buildingList.sort_by_Name();
                        sortName.print();
                        break;
                    }
            case 3: {   cout << "Buildings are in non-descending order by buildings' IDs: " << endl;
                        BuildingList sortID=UKY_buildingList.sort_by_ID();
                        sortID.print();
                        break;
                    }
            case 4: {   cout << "Buildings are in reverse dictionary order by buildings' coordinates: " << endl;
                        BuildingList sortCoord=UKY_buildingList.sort_by_Reverse_Coordinate();
                        sortCoord.print();
                        break;
                    }
            default:
