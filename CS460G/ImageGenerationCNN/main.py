...
class RNNModel(nn.Module):
    ...
    def sample(self, outputLength, start):
...
# Initialize device used for training and initialize training data
...
# Train model
model.trainModel(inputSequence, outputSequence, 10)

# Test model through predictions
print("Model trained. Testing sample output:")
print(model.sample(100, 'Citizens'))
